...
def fea():
    a = pd.read_excel(r'C:\Users\lenovo\Desktop\SCI\第三篇SCI\自己整理的\总的(不含细胞因子).xlsx', header=None)
    ...
    dd = pd.read_excel(r'C:\Users\lenovo\Desktop\SCI\第三篇SCI\自己整理的\细胞特征.xlsx', index_col='细胞')
    ...
    M1 = coo_matrix((fz.iloc[:, 2], (fz.iloc[:, 0], fz.iloc[:, 1]))).toarray()
