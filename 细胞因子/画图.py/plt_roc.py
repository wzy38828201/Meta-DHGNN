...
def get_micro_acm_roc():
    att_fpr, att_tpr, att_roc_auc = micro(r'G:\图神经网络编程\有向异构\dglhan改实验\结果\Meta-GNN\\')
    ori_fpr,ori_tpr,ori_roc_auc = micro(r'G:\图神经网络编程\有向异构\dglhan改实验\结果\原始\\')
    meta_fpr,meta_tpr,meta_roc_auc = micro(r'G:\图神经网络编程\有向异构\dglhan改实验\结果\仅meta\\')
    adj_fpr,adj_tpr,adj_roc_auc = micro(r'G:\图神经网络编程\有向异构\dglhan改实验\结果\仅adj\\')
    all_fpr,all_tpr,all_roc_auc = micro(r'G:\图神经网络编程\有向异构\dglhan改实验\结果\all\\')
    ...
    plt.legend(loc="lower right")
    # plt.show()
    plt.savefig(r'G:\图神经网络编程\有向异构\dglhan改实验\结果\细胞因子_micro-average_ROC.png', dpi=500)
