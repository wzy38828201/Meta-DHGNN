...
paths = [
    # r'G:\图神经网络编程\有向异构\dglhan改实验\结果\Meta-GNN',
    # r'G:\图神经网络编程\有向异构\dglhan改实验\结果\原始',
    # r'G:\图神经网络编程\有向异构\dglhan改实验\结果\仅meta',
    r'G:\图神经网络编程\有向异构\dglhan改实验\结果\仅adj',
    # r'G:\图神经网络编程\有向异构\dglhan改实验\结果\all'
         ]
