...
score_path1 = r"G:\图神经网络编程\有向异构\dglhan改实验\结果\原始\pr曲线.txt"  # 文件路径，先生成prob文件
score_path2 = r"G:\图神经网络编程\有向异构\dglhan改实验\结果\仅adj\pr曲线.txt"  # 文件路径，先生成prob文件
score_path3 = r"G:\图神经网络编程\有向异构\dglhan改实验\结果\仅meta\pr曲线.txt"  # 文件路径，先生成prob文件
score_path4 = r"G:\图神经网络编程\有向异构\dglhan改实验\结果\Meta-GNN\pr曲线.txt"  # 文件路径，先生成prob文件
score_path5 = r"G:\图神经网络编程\有向异构\dglhan改实验\结果\all\pr曲线.txt"  # 文件路径，先生成prob文件
...
plt.xlim([-0.01, 1.01])
plt.ylim([-0.01, 1.01])
plt.xlabel('recall',fontdict=font,size = 25)
plt.ylabel('precision',fontdict=font,size = 25)
plt.title('Macro-average PR curve on the cytokines',fontdict=font,size = 25)
...
plt.savefig(r'G:\图神经网络编程\有向异构\dglhan改实验\结果\细胞因子-PRC.png',dpi=600)
plt.savefig(r'G:\图神经网络编程\有向异构\dglhan改实验\结果\细胞因子-PRC.pdf', dpi=600,bbox_inches='tight', format="pdf")
